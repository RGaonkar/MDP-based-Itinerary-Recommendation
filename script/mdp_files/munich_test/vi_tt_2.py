...
actions = pickle.load(open("time_tt" + "/history_2" + "/actions.p", "rb"))  #list of strings containing place categories 
states = pickle.load(open("time_tt" + "/history_2" + "/states.p", "rb"))   #list of tuples containing places - (place1, place2)
transitions = pickle.load(open("time_tt" + "/history_2" + "/transition_prob.p", "rb"))  #dictionary to store the transition
rewards = pickle.load(open("time_tt" + "/history_2" + "/rewards.p", "rb"))
...
pickle.dump(V2, open("time_tt" + "/history_2" + "/utilities.p", "wb"))
pickle.dump(policy, open("time_tt" + "/history_2" + "/policy.p", "wb"))
